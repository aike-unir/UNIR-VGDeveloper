...
namespace juego2 {
    ...
    string JuegoMesa2::carpeta_habilids_juego {"./habilidades/"};
    ...
    void JuegoMesa2::preparaTablero () {
    ...
    void JuegoMesa2::preparaPersonajes () {
    ...
    void JuegoMesa2::preparaHabilidades () {
    ...
    void JuegoMesa2::preparaTiposEstadisticas () {
    ...
    void JuegoMesa2::agregaHabilidadesPersonajes () {
    ...
    void JuegoMesa2::agregaEstadisticasHabilidades () {
    ...
    void JuegoMesa2::agregaEstadisticasPersonajes () {
    ...
    void JuegoMesa2::preparaSistemaAtaque () {
    ...
    void JuegoMesa2::configuraJuego () {
